...
class FragmentOne : Fragment() {
    ...
    private lateinit var mDelegate: FragmentOneDelegate
    ...
    override fun onCreateView(
        ...
        val btnHello = view.findViewById<Button>(R.id.btnFragOne)
        btnHello.setOnClickListener { mDelegate.onTapButtonHello() }
        return view
    }
...
//        mDelegate = context as FragmentOneDelegate
    }
